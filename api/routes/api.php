...
//============================== RUTAS REGISTRO UNIDADES =======================================
    ...
    Route::post('editar.unidades'     ,'unidadesController@editarUnidades')      -> name('editarUnidades');
    Route::put('actualizar.unidades'  ,'unidadesController@actualizarUnidades')  -> name('actualizarUnidades');
