<template>
  <v-content class="pa-0 ma-3">
  	<v-row class="justify-center">
  		<v-col cols="12">
				<v-card-actions class="font-weight-black headline"> Ordenes de Trabajo </v-card-actions>
			    ...
			    >
			    	...
			    	<template v-slot:item.action="{ item }" > 
			    		<v-btn  class="celeste" icon dark @click="abrirModal(2, item)"><v-icon> create </v-icon></v-btn> <!-- infoar -->
				    </template>
				...
				<div class="text-center pt-2">
				 ...
				 <!-- <v-dialog persistent v-model="dialog" width="700px" >	
		    		...
		    		<ControlUsuario :modoVista="modoVista" :info="info" @modal="dialog = $event" />
		    	</v-card>
		    </v-dialog> -->
