<template>
  <v-container>
  	<v-row class="justify-center">
  		<v-col cols="12">
				<v-card-actions> <h3><strong> Catálogo de Manos de Obra</strong></h3></v-card-actions><v-divider></v-divider>
		    	...
		    	<v-card>
		    		<ControlManosdeObra :param="param" :edit="edit" @modal="dialog = $event" />
		    	</v-card>
		    </v-dialog>
